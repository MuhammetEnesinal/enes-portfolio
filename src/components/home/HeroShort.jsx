    ...
    >
      <div className="max-w-2xl space-y-6">
        ...
        <p className="text-gray-700 text-lg leading-relaxed max-w-xl">
          ...
          geliştiriyorum. Algoritmalar, veri yapıları ve yapay zeka üzerine
          çalışarak hem akademik hem de uygulamalı deneyimler ediniyorum.
        </p>

        <div className="flex gap-4 pt-4">
          <a
            href="#projects"
            className="bg-blue-600 hover:bg-blue-700 text-white px-7 py-3 rounded-xl shadow-lg shadow-blue-200 transition-all hover:-translate-y-1"
          >
            Projelerimi Gör
          </a>
